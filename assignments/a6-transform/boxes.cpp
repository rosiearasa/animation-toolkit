...
public:
   ...
   void scene()
   {
      ...
      // Question 2
      Transform F21 = F10.inverse()*F30; // transform from frame 2 to frame 1
      ...
      Transform F32 = F21.inverse()*F10.inverse()*F30;
      ...
      quat rot_inverse = glm::angleAxis(0.f, vec3(0,0, 1));
      vec3 d1 = vec3(0,2,0);
        //std::cout <<  << std::endl;
      Transform F = Transform(rot_inverse, d1);
      //std::cout << F << std::endl;
